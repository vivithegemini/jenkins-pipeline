    ...
    stages {
        ...
        stage('dockerImageTag'){
            steps{
                ...
                sh 'docker tag imageversion 954976287271.dkr.ecr.us-east-1.amazonaws.com/jenkins-ci:v1.$BUILD_NUMBER'
            }
        }
        stage('pushImage'){
            steps{
                sh 'docker push 954976287271.dkr.ecr.us-east-1.amazonaws.com/jenkins-ci:latest'
                sh 'docker push 954976287271.dkr.ecr.us-east-1.amazonaws.com/jenkins-ci:v1.$BUILD_NUMBER'
            }
        }
    }
}